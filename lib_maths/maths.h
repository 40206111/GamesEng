...
namespace sf
{
	//Create a definition for sf::vector using size_t types
	...
	//Allow castng from one sf::vector internal type to another
	...
	//Rotate a sf::vector by an agle(degrees)
	template <typename T>
